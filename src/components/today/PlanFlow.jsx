...
export default function PlanFlow({
  ...
  /*
    An ordinary block on an ordinary page, every step of the four. The step's
    body is as tall as it is and the window scrolls it: a shell that fixed
    itself to the height of the screen would be handing each step a scrollbar of
    its own, and four steps that each move differently is not one flow.
  */
  return (
    <div>
      {/*
